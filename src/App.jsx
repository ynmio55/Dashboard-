...
export default function App() {
  ...
  return (
    <div className="flex min-h-[100dvh] bg-slate-50 font-sans">
          ...
          {(() => {
            ...
            return navItems.map(([id, Icon, label]) => (
              <button
                ...
                className={`w-full flex items-center ${showSidebarLabels ? 'justify-start px-4' : 'justify-center px-0'} gap-3 py-3.5 rounded-xl font-bold text-base transition-all duration-200 ${activeTab === id
      ...
      {/* Main Content Area */}
      <div className="flex-grow flex flex-col min-w-0 h-[100dvh] overflow-y-auto">
                ...
                {isGenderFilterVisible && (
                  <div className="flex shrink-0 items-center bg-white/10 backdrop-blur-md p-1 rounded-full border border-white/20 shadow-sm">
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-full text-xs font-bold transition-all duration-200 cursor-pointer ${selectedGender === 'all'
                    ...
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-full text-xs font-bold transition-all duration-200 cursor-pointer ${selectedGender === 'ชาย'
                    ...
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-full text-xs font-bold transition-all duration-200 cursor-pointer ${selectedGender === 'หญิง'
